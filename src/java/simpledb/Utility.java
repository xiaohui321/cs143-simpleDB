...
public class Utility {
     ...
     */
    public static Type[] getTypes(final int len) {
     ...
     *         (val1, val2, etc.).
     */
    public static String[] getStrings(final int len, final String val) {
     ...
     *         + n (name1, name2, etc.).
     */
    public static TupleDesc getTupleDesc(final int n, final String name) {
     ...
     */
    public static TupleDesc getTupleDesc(final int n) {
     ...
     */
    public static Tuple getHeapTuple(final int n) {
     ...
     *         RecordId(HeapPageId(1, 2), 3)
     */
    public static Tuple getHeapTuple(final int[] tupdata) {
     ...
     *         RecordId(HeapPageId(1, 2), 3)
     */
    public static Tuple getHeapTuple(final int n, final int width) {
     ...
     */
    public static Tuple getTuple(final int[] tupledata, final int width) {
     ...
     */
    public static HeapFile createEmptyHeapFile(final String path, final int cols)
	    throws IOException {
	...
	try {
	    ...
	    throw new RuntimeException(
		    "failed to create empty page in HeapFile");
	}
     ...
     */
    public static HeapFile openHeapFile(final int cols, final File f) {
    ...
    public static HeapFile openHeapFile(final int cols, final String colPrefix,
	    final File f) {
	// create the HeapFile and add it to the catalog
